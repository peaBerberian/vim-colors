...
hi vimIsCommand      guifg=#00afff guibg=none    gui=none ctermfg=62   ctermbg=none cterm=none
...
"JavaScript
hi jsModules         guifg=none guibg=none gui=bold ctermfg=106 ctermbg=none cterm=bold
hi jsModuleWords     guifg=none guibg=none gui=bold ctermfg=107 ctermbg=none cterm=bold
hi jsClass           guifg=none guibg=none gui=bold ctermfg=226 ctermbg=none cterm=bold
hi jsGlobalObjects   guifg=none guibg=none gui=none ctermfg=227 ctermbg=none cterm=none
hi jsHtmlElemAttrs   guifg=none guibg=none gui=none ctermfg=250 ctermbg=none cterm=none
hi jsHtmlElemFuncs   guifg=none guibg=none gui=none ctermfg=250 ctermbg=none cterm=none
hi jsSuper           guifg=none guibg=none gui=none ctermfg=227 ctermbg=none cterm=none
hi jsThis            guifg=none guibg=none gui=none ctermfg=227 ctermbg=none cterm=none
hi jsExportContainer guifg=none guibg=none gui=bold ctermfg=252 ctermbg=none cterm=bold
hi jsFunction        guifg=none guibg=none gui=bold ctermfg=62  ctermbg=none cterm=bold
hi jsArrowFunction   guifg=none guibg=none gui=bold ctermfg=62  ctermbg=none cterm=bold
...
hi jsFuncArgs        guifg=none guibg=none gui=none ctermfg=62  ctermbg=none cterm=none
hi jsReturn          guifg=none guibg=none gui=bold ctermfg=31  ctermbg=none cterm=bold
hi jsStorageClass    guifg=none guibg=none gui=none ctermfg=62  ctermbg=none cterm=none
hi jsPrototype       guifg=none guibg=none gui=none ctermfg=62  ctermbg=none cterm=none
...
hi jsDocTags         guifg=none guibg=none gui=none ctermfg=64 ctermbg=233 cterm=none
hi jsDocType         guifg=none guibg=none gui=none ctermfg=65 ctermbg=233 cterm=none
hi jsDocTypeNoParam  guifg=none guibg=none gui=none ctermfg=65 ctermbg=233 cterm=none
hi jsDocParam        guifg=none guibg=none gui=none ctermfg=245 ctermbg=234 cterm=none

"General
hi Keyword       guibg=none guifg=none gui=none ctermfg=227 ctermbg=none cterm=none
...
hi Statement     guibg=none guifg=none gui=none ctermfg=62 ctermbg=none cterm=none
...
hi Directory     guibg=none guifg=none gui=none ctermfg=227 ctermbg=none cterm=none

"Types
hi Number        guibg=none guifg=none gui=none ctermfg=3  ctermbg=none cterm=none
hi Float         guibg=none guifg=none gui=none ctermfg=3  ctermbg=none cterm=none
hi Boolean       guibg=none guifg=none gui=bold ctermfg=3  ctermbg=none cterm=bold
hi Constant      guibg=none guifg=none gui=none ctermfg=3  ctermbg=none cterm=none
hi String        guibg=none guifg=none gui=none ctermfg=3 ctermbg=236 cterm=none
hi Type          guibg=none guifg=none gui=none ctermfg=62 ctermbg=none cterm=none
hi Typedef       guibg=none guifg=none gui=none ctermfg=62 ctermbg=none cterm=none
hi Function      guibg=none guifg=none gui=bold ctermfg=62 ctermbg=none cterm=bold
